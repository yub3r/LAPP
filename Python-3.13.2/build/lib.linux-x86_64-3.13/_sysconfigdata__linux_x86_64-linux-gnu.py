...
build_time_vars = {
    ...
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': '/usr/local/python3.13/bin',
    'BINLIBDEST': '/usr/local/python3.13/lib/python3.13',
    ...
    'CONFIG_ARGS': "'--enable-optimizations' '--prefix=/usr/local/python3.13'",
    'CONFINCLUDEDIR': '/usr/local/python3.13/include',
    'CONFINCLUDEPY': '/usr/local/python3.13/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/home/administrator/LAPP/Python-3.13.2/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/home/administrator/LAPP/Python-3.13.2/lcov-report',
    'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage --title "CPython 3.13 LCOV report [commit $(shell )]"',
    'CPPFLAGS': '-I. -I./Include',
    'CXX': 'g++',
    'DESTDIRS': '/usr/local/python3.13 /usr/local/python3.13/lib /usr/local/python3.13/lib/python3.13 /usr/local/python3.13/lib/python3.13/lib-dynload',
    'DESTLIB': '/usr/local/python3.13/lib/python3.13',
    'DESTPATH': '',
    'DESTSHARED': '/usr/local/python3.13/lib/python3.13/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/usr/local/python3.13/bin/python3.13',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'INCLDIRSTOMAKE': '/usr/local/python3.13/include /usr/local/python3.13/include /usr/local/python3.13/include/python3.13 /usr/local/python3.13/include/python3.13',
    'INCLUDEDIR': '/usr/local/python3.13/include',
    'INCLUDEPY': '/usr/local/python3.13/include/python3.13',
    ...
    'LDVERSION': '3.13',
    'LIBC': '',
    'LIBDEST': '/usr/local/python3.13/lib/python3.13',
    'LIBDIR': '/usr/local/python3.13/lib',
    ...
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/usr/local/python3.13/lib/pkgconfig',
    'LIBPL': '/usr/local/python3.13/lib/python3.13/config-3.13-x86_64-linux-gnu',
    'LIBPYTHON': '',
    ...
    'MACHDEP': 'linux',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/usr/local/python3.13/lib/python3.13',
    'MACOSX_DEPLOYMENT_TARGET': '',
    'MAJOR_IN_MKDEV': 0,
    'MAJOR_IN_SYSMACROS': 1,
    'MAKESETUP': './Modules/makesetup',
    'MANDIR': '/usr/local/python3.13/share/man',
    'MIMALLOC_HEADERS': '\\',
    ...
    'RETSIGTYPE': 'void',
    'RUNSHARED': '',
    'SCRIPTDIR': '/usr/local/python3.13/lib',
    ...
    'VERSION': '3.13',
    'WASM_ASSETS_DIR': './usr/local/python3.13',
    'WASM_STDLIB': './usr/local/python3.13/lib/python3.13/os.py',
    'WHEEL_PKG_DIR': '',
    'WINDOW_HAS_FLAGS': 1,
    ...
    'abs_builddir': '/home/administrator/LAPP/Python-3.13.2',
    'abs_srcdir': '/home/administrator/LAPP/Python-3.13.2',
    'datarootdir': '/usr/local/python3.13/share',
    'exec_prefix': '/usr/local/python3.13',
